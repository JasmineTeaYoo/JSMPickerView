...
@interface JSMBasePickViewController ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation JSMBasePickViewController
- (instancetype)init{
    if (self = [super init]) {
...
-(void)initUI{
    ...
    [_cancleBtn setTitleColor:[UIColor colorWithRed:65.0/255 green:164.0/255 blue:249.0/255 alpha:1] forState:0];
    ...
    [_ensureBtn setTitleColor:[UIColor colorWithRed:65.0/255 green:164.0/255 blue:249.0/255 alpha:1] forState:0];
...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView {
    return _JSMPickerdataArr.count;
}

- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component {
    return _JSMPickerdataArr[component].count;
}

- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    return _JSMPickerdataArr[component][row];
}

- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    return [UIScreen mainScreen].bounds.size.width / _JSMPickerdataArr.count;
}
